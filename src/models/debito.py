...
class Debito(BaseModel):
    ...
    debito_id_cuenta = ForeignKeyField(Cuenta, backref='debitos')
    debito_id_peaje = ForeignKeyField(Peaje, backref='debitos')
    debito_id_vehiculo = ForeignKeyField(Vehiculo, backref='debitos')
    debito_id_ventanilla = ForeignKeyField(Ventanilla, backref='debitos')
