...
class Bonificacion(BaseModel):
    ...
    bonificacion_id_peaje = ForeignKeyField(Peaje, backref='bonificaciones', null=False)
    bonificacion_id_cuenta = ForeignKeyField(Cuenta, backref='bonificaciones', null=False)
