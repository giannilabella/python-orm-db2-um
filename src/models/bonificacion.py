...
class Bonificacion(BaseModel):
    ...
    bonificacion_peaje = ForeignKeyField(Peaje, backref='bonificaciones', on_delete='CASCADE', null=False)
    bonificacion_cuenta = ForeignKeyField(Cuenta, backref='bonificaciones', on_delete='CASCADE', null=False)
